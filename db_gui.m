...
% (2.1) draw main ui
    function [gui, data] = draw_main()
        ...
        gui.main = figure('DockControls', 'off', ...
            ...
            'NumberTitle', 'off', ...
            'Color', bgColor, ...
            'Position', [screenSz(1)/4, screenSz(2)+screenSz(2)/5, 960, 720], ...
            'ToolBar', 'none', ...
            'Resize', 'off');
...
% (2.2) draw project table controls
    function [ui, dat] = draw_project(main)
        ...
        ui.key_text = uicontrol('Parent', ui.panel, ...
            ...
            'HorizontalAlignment', 'center', ...
            'Visible', 'on', ...
            'Position', [10 15 66 26]);
        ui.key_popup = uicontrol('Parent', ui.panel, ...
            'Style', 'popupmenu', ...
            'Units', 'pixel', ...
            'Enable', 'on', ...
            'Visible', popup_state, ...
            'Position', [90 41 220 4], ...
            'FontSize', 10, ...
            'String', key_string, ...
            'Value', 1, ...
...
% (2.3) draw experiment table controls
    function [ui, dat] = draw_experiment(main, project_id)
        ...
        ui.panel = uipanel('Parent', main, ...
            ...
            'HighlightColor', [0 0 0], ...
            'Units', 'norm', ...
            'Position', [0.5125 0.7625, 0.4625, 0.1875]);
        ui.title_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'norm', ...
            'FontSize', 12, ...
        ...
        ui.key_text = uicontrol('Parent', ui.panel, ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [0.05 0.25*1.75 0.15 0.19]);
        ui.key_popup = uicontrol('Parent', ui.panel, ...
            'Style', 'popupmenu', ...
            'Units', 'norm', ...
            'Enable', 'on', ...
        ...
        ui.experimenter_edit = uicontrol('Parent', ui.panel, ...
            ...
            'Enable', 'on', ...
            'Visible', edit_state, ...
            'Position', [0.24 0.2050*2.17 0.498 0.285/1.5]);
        ui.key_add_btn = uicontrol('Parent', ui.panel, ... 
            'Style', 'pushbutton', ...
            'Units', 'norm', ...
            'Enable', edit_state, ...
            ...
            'Position', [0.78 0.225*2.17 0.05 0.275/1.5]);
        ui.key_rem_btn = uicontrol('Parent', ui.panel, ... 
            'Style', 'pushbutton', ...
            'Units', 'norm', ...
            'Enable', popup_state, ...
            ...
            'Position', [0.84 0.225*2.17 0.05 0.275/1.5]);
        ui.key_cancel_btn = uicontrol('Parent', ui.panel, ... 
            'Style', 'pushbutton', ...
            'Units', 'norm', ...
            'Enable', edit_state, ...
            ...
            'Position', [0.9 0.225*2.17 0.05 0.275/1.5]);
    end
