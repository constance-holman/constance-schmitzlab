...
% (2.1) draw main ui
    function [gui, data] = draw_main()
        ...
        % quickselect
        [gui.quickselect2] = ...
            draw_quickselect2(gui.main);
        % recording
        [gui.recording, data.recording] = ...
            draw_recording(gui.main, data.session.active, ...
            data.amplifier.active, data.probe.active);
        % ephys (LFP, Patch, Juxta)
        [gui.ephys, data.ephys] = ...
            draw_ephys(gui.main, data.recording.active);
        % stimulus (optoStim, ElectroStim)
        [gui.stimulus, data.stimulus] = ...
            draw_stimulus(gui.main, data.recording.active);
        % druginjection
        [gui.druginjection, data.druginjection] = ...
            draw_druginjection(gui.main, data.recording.active);
        % histology
        [gui.histology, data.histology] = ...
            draw_histology(gui.main, data.recording.active);
        % anatomy
        [gui.anatomy, data.anatomy] = ...
            draw_anatomy(gui.main, data.histology.active);
        % turn page
        [gui.next3] = ...
            draw_next3(gui.main);
    end
...
% (2.16) draw next button panel
    function [ui] = draw_next2(main)
        ...
        ui.back_btn = uicontrol('Parent', ui.panel, ... 
            'Style', 'pushbutton', ...
            'Units', 'pixel', ...
            'Enable', 'on', ...
            'Visible', 'on', ...
...
% (2.17) draw key quick select controls
    function [ui] = draw_quickselect2(main)
        % get table data
        ui = struct(); % struct with ui handles
        session_key_str = {''};
        probe_key_str = {''};
        ...
        ui.session_text = uicontrol('Parent', ui.panel, ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [15 132.5 66 26]);
        ui.session_popup = uicontrol('Parent', ui.panel, ...
            'Style', 'popupmenu', ...
            'Units', 'pixel', ...
            'Enable', 'on', ...
            'Visible', 'on', ...
            'Position', [15 135 170 4], ...
            'FontSize', 10, ...
            'String', session_key_str, ...
            'Value', 1, ...
            'TooltipString', 'Select a session', ...
            'Callback', @session_select_fcn);
        ui.probe_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
            'FontSize', 10, ...
            'String', 'Probe:', ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [15 85 90 26]);
        ui.probe_popup = uicontrol('Parent', ui.panel, ...
            'Style', 'popupmenu', ...
            'Units', 'pixel', ...
            'Enable', 'on', ...
            'Visible', 'on', ...
            'Position', [15 87.5 170 4], ...
            'FontSize', 10, ...
            'String', probe_key_str, ...
            'Value', 1, ...
            'TooltipString', 'Select a probe', ...
            'Callback', @probe_select_fcn);
        ui.amplifier_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
            'FontSize', 10, ...
            'String', 'Amplifier:', ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [15 37.5 66 26]);
        ui.amplifier_popup = uicontrol('Parent', ui.panel, ...
            'Style', 'popupmenu', ...
            'Units', 'pixel', ...
            'Enable', 'on', ...
            'Visible', 'on', ...
            'Position', [15 40 170 4], ...
            'FontSize', 10, ...
            'String', amplifier_key_str, ...
            'Value', 1, ...
            'TooltipString', 'Select an amplifier', ...
            'Callback', @amplifier_select_fcn);
    end

% (2.18) draw Recording table controls
    function [ui, dat] = draw_recording(main, session, amplifier, probe)
        % get table data
        ui = struct(); % struct with ui handles
        dat = struct(); % struct with table data
        try
            [dat.id, dat.session_id, dat.probe_id, dat.amplifier_id, dat.depth, dat.note] = ...
        ...
        if numel(dat.id) == 0 % empty table
            ...
            popup_state = 'on'; % show key select popup
            edit_state = 'off';
            key_str = keystr_zipper(dat.note, dat.id);
            depth_str = dat.depth(1);
            note_str = dat.note(1);
            dat.active = dat.id(1);
        end
        ...
        ui.key_text = uicontrol('Parent', ui.panel, ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [15 83 66 26]);
        ui.key_popup = uicontrol('Parent', ui.panel, ...
            'Style', 'popupmenu', ...
            'Units', 'pixel', ...
            'Enable', popup_state, ...
            'Visible', 'on', ...
            'Position', [70 109 202.5 4], ...
            'FontSize', 10, ...
            'String', key_str, ...
            'Value', 1, ...
            'TooltipString', 'Select a recording', ...
            'Callback', @recording_select_fcn);
        ui.depth_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
            'FontSize', 10, ...
            'String', 'Depth:', ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [15 48 66 26]);
        ui.depth_edit = uicontrol('Parent', ui.panel, ...
            'Style', 'edit', ...
            'Units', 'pixel', ...
            'Enable', edit_state, ...
            'String', depth_str, ...
            'Visible', 'on', ...
            'Position', [70 53 202.5 25]);
        ui.note_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
            'FontSize', 10, ...
        ...
        ui.key_add_btn = uicontrol('Parent', ui.panel, ... 
            ...
            'Visible', 'on', ...
            'String', '+', ...
            'Callback', @recording_add_fcn, ...
            'Position', [292.5 88 25 25]);
        ui.key_rem_btn = uicontrol('Parent', ui.panel, ... 
            'Style', 'pushbutton', ...
            'Units', 'pixel', ...
            'Enable', popup_state, ...
            'Visible', 'on', ...
            'String', '-', ...
            'Callback', @recording_rem_fcn, ...
            'Position', [292.5 58 25 25]);
        ui.key_cancel_btn = uicontrol('Parent', ui.panel, ... 
            'Style', 'pushbutton', ...
            'Units', 'pixel', ...
            'Enable', popup_state, ...
            'Visible', 'on', ...
            'String', 'x', ...
            'Callback', @recording_cancel_fcn, ...
            'Position', [292.5 28 25 25]);
    end

% (2.19) draw EPhys table controls
    function [ui, dat] = draw_ephys(main, recording)
        % get table data
        ui = struct(); % struct with ui handles
        dat = struct(); % struct with table data
        
        dat.types = {'LFP'; 'Juxta'; 'Patch'};
        dat.active = 1;
        
        try
            [dat.channel, dat.duration, dat.type] = ...
                mysql(sprintf(['select channel, (max(time)-min(time)) as duration, type from ', ...
                '(select rec_id, channel, time, ''LFP'' as type  from LFP ', ...
                'union ', ...
                'select rec_id, channel, time, ''Juxta'' as type from Juxta ', ...
                'union ', ...
                'select rec_id, channel, time, ''Patch'' as type from Patch) ', ...
                'as TMP where rec_id = %d and type = ''%s'' group by channel'], recording, dat.types{dat.active}));
            dat.channel = str2double(dat.channel);
        catch err
            dat.channel = [];
            dat.duration = [];
            dat.type = [];
        end
        if numel(dat.channel) == 0 % empty table
            state = 'off';
        else % populated table
            state = 'on';
        end
        ...
        ui.panel = uipanel('Parent', main, ...
            ...
            'HighlightColor', [0 0 0], ...
            'Units', 'pixel', ...
            'Position', [622.5 427.5 352.5 197.5], ...
            'Visible', 'off');
        ui.title_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
            ...
            'HorizontalAlignment', 'center', ...
            'Visible', 'on', ...
            'Position', [122.5 163.5 100 26]);
        ui.subtitle_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
            'FontSize', 8, ...
            'String', sprintf('( Channel: %d )', numel(dat.channel)), ...
            'Enable', 'on', ...
            'HorizontalAlignment', 'center', ...
            'Visible', 'on', ...
            'Position', [227.5 160 75 26]);
        ui.type_popup = uicontrol('Parent', ui.panel, ...
            'Style', 'popupmenu', ...
            'Units', 'pixel', ...
            'Enable', state, ...
            'Visible', 'on', ...
            'Position', [21 186 70 4], ...
            'FontSize', 10, ...
            'String', dat.types, ...
            'Value', 1, ...
        ...
        ui.table = uitable('Parent', ui.panel, ...
            'ColumnName', {'Channel', 'Duration'}, ...
            'ColumnFormat', {'numeric', 'numeric'}, ...
            'ColumnWidth', {120, 120}, ...
            'ColumnEditable', [false, false], ...
            'Data', [dat.channel, dat.duration], ...
            'Units', 'pixel', ...
            'Position', [20 50 267.5 110], ...
            'RowName', [], ...
            'FontSize', 10);
        ui.file_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
        ...
        ui.key_cancel_btn = uicontrol('Parent', ui.panel, ... 
            ...
            'Position', [307.5 70 25 25]);
    end

% (2.20) draw (Opto/Electro)Stimulus table controls
    function [ui, dat] = draw_stimulus(main, recording)
                % get table data
        ui = struct(); % struct with ui handles
        dat = struct(); % struct with table data
        
        dat.types = {'Electro'; 'Opto'; 'VR'; 'Other'};
        dat.active = 1;
        
        try
            [dat.time, dat.voltage] = ...
                mysql(sprintf('select time, voltage from ElectroStim where rec_id = %d', recording));
        catch err
            dat.time = [];
            dat.voltage = [];
        end
        ...
        ui.panel = uipanel('Parent', main, ...
            ...
            'HighlightColor', [0 0 0], ...
            'Units', 'pixel', ...
            'Position', [622.5 250 352.5 157.5], ...
            'Visible', 'off');
        ui.title_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
        ...
        ui.subtitle_text = uicontrol('Parent', ui.panel, ...
            ...
            'HorizontalAlignment', 'center', ...
            'Visible', 'on', ...
            'Position', [227.5 120 75 26]);
        ui.type_popup = uicontrol('Parent', ui.panel, ...
            'Style', 'popupmenu', ...
            'Units', 'pixel', ...
            'Enable', state, ...
            'Visible', 'on', ...
            'Position', [21 146 70 4], ...
            'FontSize', 10, ...
            'String', dat.types, ...
            'Value', 1, ...
            'TooltipString', 'Select a data type', ...
        ...
        ui.electro_table = uitable('Parent', ui.panel, ...
            ...
            'ColumnWidth', {120, 120}, ...
            'ColumnEditable', [false, false], ...
            'Data', [dat.time, dat.voltage], ...
            'Units', 'pixel', ...
            'Position', [20 20 267.5 100], ...
            'RowName', [], ...
            'FontSize', 10);
        ui.opto_table = uitable('Parent', ui.panel, ...
            'ColumnName', {'Time', 'Voltage', 'wavelength'}, ...
            'ColumnFormat', {'numeric', 'numeric', 'numeric'}, ...
            'ColumnWidth', {80, 80, 80}, ...
            'ColumnEditable', [false, false, false], ...
            'Data', [[], [], []], ...
...
% (2.21) draw DrugInjection table controls
    function [ui, dat] = draw_druginjection(main, recording)
        % get table data
        ui = struct(); % struct with ui handles
        dat = struct(); % struct with table data
        try
        ...
        if numel(dat.drug) == 0 % empty table
            if recording == -1
                button_state = 'off';
            else
                button_state = 'on';
        ...
        ui.panel = uipanel('Parent', main, ...
            ...
            'HighlightColor', [0 0 0], ...
            'Units', 'pixel', ...
            'Position', [255 241.5 342.5 206.5], ...
            'Visible', 'off');
        ui.title_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
            'FontSize', 12, ...
            'FontWeight', 'bold', ...
            'String', 'DrugInjection', ...
            'Enable', 'on', ...
            'HorizontalAlignment', 'center', ...
            'Visible', 'on', ...
            'Position', [113.75 161.5 115 26]);
        ui.subtitle_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
            'FontSize', 8, ...
            'String', sprintf('( Rows: %d )', numel(dat.drug)), ...
            'Enable', 'on', ...
            'HorizontalAlignment', 'center', ...
            'Visible', 'on', ...
            'Position', [267.5 157 70 26]);
        ui.table = uitable('Parent', ui.panel, ...
            'ColumnName', {'Drug', 'Time', 'Volume', 'Type'}, ...
            'ColumnFormat', {'char', 'char', 'numeric', 'char'}, ...
            'ColumnWidth', {60, 60, 60, 60}, ...
            'ColumnEditable', [false, false, false, false], ...
            'Data', [dat.drug, num2cell(dat.time), num2cell(dat.volume), dat.type], ...
            'Units', 'pixel', ...
            'Position', [20 15 267.5 141], ...
            'RowName', [], ...
            'Visible', table_state, ...
            'FontSize', 10, ...
            'CellSelectionCallback', @druginjection_select_fcn);
        ui.drug_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
            'FontSize', 10, ...
            'String', 'Drug:', ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [15 114 66 26]);
        ui.drug_edit = uicontrol('Parent', ui.panel, ...
            'Style', 'edit', ...
            'Units', 'pixel', ...
            'Enable', 'on', ...
            'String', '', ...
            'Visible', 'on', ...
            'Position', [70 119 202.5 25]);
        ui.time_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
            'FontSize', 10, ...
            'String', 'Time:', ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [15 79 66 26]);
        ui.time_edit = uicontrol('Parent', ui.panel, ...
            'Style', 'edit', ...
            'Units', 'pixel', ...
            'Enable', 'on', ...
            'String', '', ...
            'Visible', 'on', ...
            'Position', [70 84 202.5 25]);
        ui.volume_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
            'FontSize', 10, ...
            'String', 'Volume:', ...
        ...
        ui.key_rem_btn = uicontrol('Parent', ui.panel, ... 
            ...
            'Visible', 'on', ...
            'String', '-', ...
            'Callback', @druginjection_rem_fcn, ...
            'Position', [292.5 89 25 25]);
        ui.key_cancel_btn = uicontrol('Parent', ui.panel, ... 
            'Style', 'pushbutton', ...
            'Units', 'pixel', ...
            'Enable', button_state, ...
            'Visible', 'on', ...
            'String', 'x', ...
            'Callback', @druginjection_cancel_fcn, ...
            'Position', [292.5 59 25 25]);
    end

% (2.22) draw Histology table controls
    function [ui, dat] = draw_histology(main, recording)
        % get table data
        ui = struct(); % struct with ui handles
        dat = struct(); % struct with table data
        try
        ...
        if numel(dat.id) == 0 % empty table
            ...
            popup_state = 'on'; % show key select popup
            edit_state = 'off';
            key_str = keystr_zipper(strcat(dat.dye, '-', dat.staining), dat.id);
            dye_str = dat.dye(1);
            staining_str = dat.staining(1);
            note_str = dat.note(1);
            dat.active = dat.id(1);
        end
        ...
        ui.key_text = uicontrol('Parent', ui.panel, ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [15 118 66 26]);
        ui.key_popup = uicontrol('Parent', ui.panel, ...
            'Style', 'popupmenu', ...
            'Units', 'pixel', ...
            'Enable', popup_state, ...
            'Visible', 'on', ...
            'Position', [70 144 202.5 4], ...
            'FontSize', 10, ...
            'String', key_str, ...
            'Value', 1, ...
            'TooltipString', 'Select a histology', ...
            'Callback', @histology_select_fcn);
        ui.dye_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
            'FontSize', 10, ...
            'String', 'Dye:', ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [15 75 66 26]);
        ui.dye_edit = uicontrol('Parent', ui.panel, ...
            'Style', 'edit', ...
            'Units', 'pixel', ...
            'Enable', edit_state, ...
            'String', dye_str, ...
            'Visible', 'on', ...
            'Position', [70 80 202.5 25]);
        ui.staining_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
            'FontSize', 10, ...
            'String', 'Stain:', ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [15 40 66 26]);
        ui.staining_edit = uicontrol('Parent', ui.panel, ...
            'Style', 'edit', ...
            'Units', 'pixel', ...
            'Enable', edit_state, ...
            'String', staining_str, ...
            'Visible', 'on', ...
            'Position', [70 45 202.5 25]);
        ui.note_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
            'FontSize', 10, ...
        ...
        ui.key_rem_btn = uicontrol('Parent', ui.panel, ... 
            ...
            'Visible', 'on', ...
            'String', '-', ...
            'Callback', @histology_rem_fcn, ...
            'Position', [292.5 94 25 25]);
        ui.key_cancel_btn = uicontrol('Parent', ui.panel, ... 
            'Style', 'pushbutton', ...
            'Units', 'pixel', ...
            'Enable', popup_state, ...
            ...
            'Position', [292.5 64 25 25]);
    end

% (2.23) draw Anatomy table controls
    function [ui, dat] = draw_anatomy(main, histology)
        % get table data
        ui = struct(); % struct with ui handles
        dat = struct(); % struct with table data
                
        try
            [dat.score, dat.location, dat.channel] = ...
                mysql(sprintf('select score, location, channel from Anatomy where histology_id = %d', histology));
        catch err
            dat.score = [];
            dat.location = {''};
            dat.channel = [];
        ...
        ui.subtitle_text = uicontrol('Parent', ui.panel, ...
            ...
            'Units', 'pixel', ...
            'FontSize', 8, ...
            'String', sprintf('( Rows: %d )', numel(dat.channel)), ...
            'Enable', 'on', ...
            'HorizontalAlignment', 'center', ...
            'Visible', 'on', ...
            'Position', [227.5 160 75 26]);
        ui.table = uitable('Parent', ui.panel, ...
            'ColumnName', {'Location', 'Channel', 'Score'}, ...
            'ColumnFormat', {'numeric', 'numeric', 'numeric'}, ...
            'ColumnWidth', {80, 80, 80}, ...
            'ColumnEditable', [false, false, false], ...
            'Data', [dat.location, dat.channel, dat.score], ...
            'Units', 'pixel', ...
            'Position', [20 50 267.5 110], ...
            'RowName', [], ...
            'FontSize', 10);
        ...
        ui.key_add_btn = uicontrol('Parent', ui.panel, ... 
            ...
            'Visible', 'on', ...
            'String', '+', ...
            'Callback', @anatomy_add_fcn, ...
            'Position', [307.5 135 25 25]);
        ui.key_rem_btn = uicontrol('Parent', ui.panel, ... 
            'Style', 'pushbutton', ...
            'Units', 'pixel', ...
            'Enable', state, ...
            'Visible', 'on', ...
            'String', '-', ...
            'Callback', @anatomy_rem_fcn, ...
            'Position', [307.5 105 25 25]);
        ui.key_cancel_btn = uicontrol('Parent', ui.panel, ... 
            'Style', 'pushbutton', ...
            'Units', 'pixel', ...
            'Enable', 'off', ...
            'Visible', 'on', ...
            'String', 'x', ...
            'Callback', @anatomy_cancel_fcn, ...
            'Position', [307.5 75 25 25]);
    end

% (2.24) draw next button panel
    function [ui] = draw_next3(main)
        % draw ui controls
        ui.panel = uipanel('Parent', main, ...
            'BorderType', 'line', ...
            'HighlightColor', [0 0 0], ...
    ...
    function turn_page_fcn(src, evt)
        ...
        switch gui.page
            case 1
                ...
                set_visible(gui.remapping, 'off');
                set_visible(gui.shank, 'off');
                set_visible(gui.probe, 'off');
                set_visible(gui.sitepos, 'off');
                set_visible(gui.next2, 'off');
                set_visible(gui.quickselect2, 'off');
                set_visible(gui.recording, 'off');
                set_visible(gui.ephys, 'off');
                set_visible(gui.stimulus, 'off');
                set_visible(gui.druginjection, 'off');
                set_visible(gui.histology, 'off');
                set_visible(gui.anatomy, 'off');
                set_visible(gui.next3, 'off');
            ...
            case 3
                ...
                set_visible(gui.quickselect2, 'on');
                set_visible(gui.recording, 'on');
                set_visible(gui.ephys, 'on');   
                set_visible(gui.stimulus, 'on');
                set_visible(gui.druginjection, 'on');
                ...
                if isempty(data.druginjection.drug)
                    ...
                    set(gui.druginjection.type_popup, 'Visible', 'on');
                    set(gui.druginjection.key_rem_btn, 'Enable', 'off');
                else
                    set(gui.druginjection.table, 'Visible', 'on');
                    set(gui.druginjection.drug_text, 'Visible', 'off');
                    set(gui.druginjection.drug_edit, 'Visible', 'off');
                    set(gui.druginjection.time_text, 'Visible', 'off');
                    set(gui.druginjection.time_edit, 'Visible', 'off');
                    set(gui.druginjection.volume_text, 'Visible', 'off');
                    set(gui.druginjection.volume_edit, 'Visible', 'off');
                    set(gui.druginjection.type_text, 'Visible', 'off');
                    set(gui.druginjection.type_popup, 'Visible', 'off');
                end
...
% (3.19) DrugInjection table controls
    ...
    function druginjection_update_fcn()
        [data.druginjection.drug, data.druginjection.time, data.druginjection.volume, data.druginjection.type] = ...
                mysql(sprintf('select drug, time, volume, type from DrugInjection where rec_id = %d;', ...
                data.recording.active));
        if numel(data.druginjection.drug) == 0 % empty table
            ...
            set(gui.druginjection.table, 'Data', ...
                [data.druginjection.drug, num2cell(data.druginjection.time), ...
                num2cell(data.druginjection.volume), data.druginjection.type]);
        end
    ...
    function druginjection_rem_fcn(src, event)
        ...
        if strcmp(answ, 'Yes')
            % delete row
            mysql(sprintf('delete from DrugInjection where rec_id = %d and drug = "%s" and time = %d and volume = %d and type = "%s";', ...
            ...
            % update ui / data container
            data.druginjection.drug(val) = [];
            data.druginjection.time(val) = [];
            data.druginjection.volume(val) = [];
            data.druginjection.type(val) = [];
            set(gui.druginjection.subtitle_text, ...
                'String', sprintf('( Rows: %d )', length(data.druginjection.drug)));
            if isempty(data.druginjection.drug) % force edit mode
                set(gui.druginjection.table, 'Visible', 'off');
                set(gui.druginjection.drug_text, 'Visible', 'on');
                set(gui.druginjection.drug_edit, 'Visible', 'on');
                set(gui.druginjection.time_text, 'Visible', 'on');
