...
% (2.1) draw main ui
    function [gui, data] = draw_main()
        ...
        [gui.reward, data.reward] = ...
            draw_reward(gui.main, data.session.active);
        % rewardtype
    ...
    function [ui, dat] = draw_reward(main, session)
        ...
        try
            [dat.session_id, dat.reward_type_id, dat.time] = ...
                mysql(sprintf('select session_id, reward_type_id, time from Reward where session_id = %d;', session));
        catch err
            dat.time = [];
            dat.session_id = [];
            dat.reward_type_id = [];
        ...
        ui.subtitle_text = uicontrol('Parent', ui.panel, ...
            ...
            'HorizontalAlignment', 'center', ...
            'Visible', 'off', ...
            'Position', [165 125 80 26]);
        ui.table = uitable('Parent', ui.panel, ...
            'ColumnName', {'Type', 'Time'}, ...
            'ColumnFormat', {'numeric', 'numeric'}, ...
            'ColumnWidth', {75, 75}, ...
            'ColumnEditable', [false, false], ...
            'Data', [dat.reward_type_id, dat.time], ...
            'Units', 'pixel', ...
            'Position', [20 15 153 105], ...
            'RowName', [], ...
            'FontSize', 10);
...
% (2.9) draw reward_type table controls
    function [ui, dat] = draw_rewardtype(main)
        ...
        ui.panel = uipanel('Parent', main, ...
            ...
            'HighlightColor', [0 0 0], ...
            'Units', 'pixel', ...
            'Position', [527.5 232.5 447.5 200], ...
            'Visible', 'on');
        ui.title_text = uicontrol('Parent', ui.panel, ...
            'Style', 'text', ...
            'Units', 'pixel', ...
