...
% (2.7) draw behavior table controls
    ...
    function [ui, dat] = draw_behavior(main, session)
        ...
        dat = struct(); % struct with table data
        try
            [dat.real_x, dat.real_y, dat.virt_x, dat.virt_y, dat.time, dat.virt_end] = ...
                mysql(sprintf('select real_x, real_y, virt_x, virt_y, time, virt_end from Behavior where session_id = %d;', session));
        catch err
            dat.real_x = [];
            dat.real_y = [];
            dat.virt_x = [];
        ...
        ui.subtitle_text = uicontrol('Parent', ui.panel, ...
            ...
            'HorizontalAlignment', 'center', ...
            'Visible', 'on', ...
            'Position', [670 125 70 26]);
        ui.table = uitable('Parent', ui.panel, ...
        'ColumnName', {'RealX', 'RealY', 'VirtX', 'VirtY', 'Time', 'End'}, ...
        ...
        'Data', [dat.real_x, dat.real_y, ...
                ...
                dat.time, dat.virt_end], ...
        'Units', 'pixel', ...
        'Position', [15 50 303 75], ...
        'RowName', [], ...
        'FontSize', 10);
        ui.file_text = uicontrol('Parent', ui.panel, ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [15 7.5 66 26]);
        ui.file_edit = uicontrol('Parent', ui.panel, ...
            'Style', 'edit', ...
            'Units', 'pixel', ...
            'Enable', 'on', ...
            'Visible', edit_state, ...
            'Position', [90 15 300 25]);
