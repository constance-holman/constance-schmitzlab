...
% (2.22) draw (Opto/Electro)Stimulus table controls
...
% (2.24) draw DrugInjection table controls
    function [ui, dat] = draw_druginjection(main, recording)
        
    end

% (2.25) draw Histology table controls
    function [ui, dat] = draw_histology(main, recording)
    end

% (2.26) draw Anatomy table controls
