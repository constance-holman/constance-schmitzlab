...
%             'Position', [0.015 0.58, 0.15, 0.4]);
        project.title_text = uicontrol('Parent', main, ...
            'Style', 'text', ...
            'Units', 'norm', ...
            'FontSize', 12, ...
            'FontWeight', 'bold', ...
            ...
            'Visible', 'on', ...
            'Position', [0.15 0.7 0.5 0.0735]);
        project.name_text = uicontrol('Parent', main, ...
            'Style', 'text', ...
            'Units', 'norm', ...
            'FontSize', 10, ...
            'String', 'Name:', ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [0.1 0.65 0.5 0.0735]);
        project.name_popup = uicontrol('Parent', main, ...
            'Style', 'popupmenu', ...
            'Units', 'norm', ...
            'Enable', 'on', ...
            'Visible', 'on', ...
            'Position', [0.12 0.65 0.5 0.0735], ...
            'FontSize', 10, ...
            'String', {'Create new'}, ...
            'Value', 1, ...
