...
% (2.22) draw ElectroStim table controls
    function [ui, dat] = draw_electrostim(main, recording)
    end

% (2.23) draw OptoStim table controls
    function [ui, dat] = draw_optostim(main, recording)
    end
