...
% (2.18) draw Recording table controls
    function [ui, dat] = draw_recording(main, session, amplifier, probe)
        ...
        if numel(dat.id) == 0 % empty table
            ...
            session_str = dat.session_id(1);
            probe_str = dat.probe_id(1);
            amplifier_str = dat.amplifier_id(1);
        ...
        ui.key_text = uicontrol('Parent', ui.panel, ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [15 190 66 26]);
        ui.key_popup = uicontrol('Parent', ui.panel, ...
            'Style', 'popupmenu', ...
            'Units', 'pixel', ...
            'Enable', popup_state, ...
            'Visible', 'on', ...
            'Position', [70 216 154 4], ...
            'FontSize', 10, ...
            'String', key_str, ...
            'Value', 1, ...
        ...
        ui.session_text = uicontrol('Parent', ui.panel, ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [15 150 66 26]);
        ui.session_edit = uicontrol('Parent', ui.panel, ...
            'Style', 'edit', ...
            'Units', 'pixel', ...
            'Enable', edit_state, ...
            'String', session_str, ...
            'Visible', 'on', ...
            'Position', [70 155 154 25]);
        ui.session_popup = uicontrol('Parent', ui.panel, ...
            'Style', 'popupmenu', ...
            'Units', 'pixel', ...
            'Enable', popup_state, ...
            'Visible', 'on', ...
            'Position', [70 176 154 4], ...
            'FontSize', 10, ...
            'String', session_str, ...
            'Value', 1, ...
            'TooltipString', 'Select a session', ...
        ...
        ui.amplifier_text = uicontrol('Parent', ui.panel, ...
            ...
            'HorizontalAlignment', 'left', ...
            'Visible', 'on', ...
            'Position', [15 115 66 26]);
        ui.amplifier_edit = uicontrol('Parent', ui.panel, ...
            'Style', 'edit', ...
            'Units', 'pixel', ...
            'Enable', edit_state, ...
            'String', amplifier_str, ...
            'Visible', 'on', ...
            'Position', [70 120 154 25]);
        ui.amplifier_popup = uicontrol('Parent', ui.panel, ...
            'Style', 'popupmenu', ...
            'Units', 'pixel', ...
            'Enable', popup_state, ...
        ...
        ui.probe_text = uicontrol('Parent', ui.panel, ...
            ...
            'Visible', 'on', ...
            'Position', [15 80 66 26]);
        ui.probe_edit = uicontrol('Parent', ui.panel, ...
            'Style', 'edit', ...
            'Units', 'pixel', ...
            'Enable', edit_state, ...
            'String', probe_str, ...
        ...
        ui.key_cancel_btn = uicontrol('Parent', ui.panel, ... 
            ...
            'Position', [244 135 25 25]);
    end

% (2.19) draw LFP table controls
    function [ui, dat] = draw_lfp(main, recording)
    end

% (2.20) draw Juxta table controls
    function [ui, dat] = draw_juxta(main, recording)
    end

% (2.21) draw Patch table controls
    function [ui, dat] = draw_patch(main, recording)
    end
