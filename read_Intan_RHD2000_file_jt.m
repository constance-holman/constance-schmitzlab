...
%
%modified 15.02.16 by Constance to batch process files and extract only
%amplifier data
%
...
function [amplifier_channels, amplifier_data, aux_input_channels, aux_input_data, board_adc_channels, board_adc_data, frequency_parameters, notes, spike_triggers, supply_voltage_channels, supply_voltage_data, t_amplifier, t_aux_input, t_board_adc , t_supply_voltage] = ...
            read_Intan_RHD2000_file_jt(filename, path)
