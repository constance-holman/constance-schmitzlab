...
def convert_files(dir,probename):
    ...
    if probename == 'CNT32_edge':
        remap_list = [3,12,4,11,14,5,1,10,13,6,2,9,7,8,15,0,19,28,20,27,30,21,17,26,29,22,18,25,23,24,31,16]
        # altered with 0-indexing 20.09.17
    ...
    # NOTE all remaps are based on anatomical layout
    ...
    np.array(final_array)[remap_list]

    np.save('L80_rec1_0indexed.npy', sorted_array)
    (open('L80_rec1_0indexed', 'wb')).write(sorted_array.T.tostring())
